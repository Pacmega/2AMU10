...
class SudokuAI(competitive_sudoku.sudokuai.SudokuAI):
    ...
    class Node:
        ...
        def __init__(self, game_state: GameState, frequent_visit_c: float = 2):
            ...
            # TODO: optimization opportunity: UCT could be persisted as well
        ...
        def calculate_uct(self, parent_number_visits) -> float:
            ...
            return average_leaf_score + frequent_visit_penalty
    ...
    def compute_best_move(self, game_state: GameState) -> None:
        ...
        TODO: is the sentence below still true with MC?
        ...
        while i < max_depth:
            if game_helpers.board_filled_in(root.game_state):
                # TODO: What end state does MC have?
                break
